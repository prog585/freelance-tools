# Upwork Semantic Job Matcher

Stop scrolling job boards manually. Embed your profile once, paste job listings, get ranked matches — no keyword rules needed.

## How It Works

1. **Index your profile** — your Upwork profile (title, description, stack, portfolio) gets embedded into Qdrant using BGE embeddings
...
# 3. Edit upwork-profile.md with your profile info
...
"Senior AI Engineer","We need...","https://upwork.com/jobs/~01","60-85/hr","Python,FastAPI","2026-03-27"
```
...
```
 ...
 ────  ─────  ───────────────────────────────────────  ──────────────────────
  ...
  5    0.71   AWS Solutions Architect                  AWS, DynamoDB, CDK
  6    0.41   React Native Developer                   React Native, iOS ← correctly deprioritized
```
...
Edit `upwork-profile.md` with sections for:
- Title / headline
- Core tech stack
- Competitive advantages
- Portfolio items (these matter a lot for matching)
